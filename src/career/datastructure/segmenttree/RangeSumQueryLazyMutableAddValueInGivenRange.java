...
//        propagate(node,lo,hi);
    ...
    public void update(int index, int val) {
        update(1, 0, nums.length - 1, index,index, val);
    }
...
public class RangeSumQueryLazyMutableAddValueInGivenRange {
    public static void main(String[] args) {
//["NumArray", "sumRange", "update", "sumRange"] -> output = [null, 9, null, 8]
//[[[1, 3, 5]], [0, 2], [1, 2], [0, 2]]
        NumArrayLazy numArray=new NumArrayLazy(new int[]{1, 3, 5});
