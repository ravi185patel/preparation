...
//        return maxProfitDpOp(prices,0,0);
    ...
    public static int maxProfitRec(int[]prices,int flag,int index){
        ...
        if(flag == 0){ // will buy
            ...
            profit = Math.max(maxProfitRec(prices,1,index+1),prices[index]+maxProfitRec(prices,0,index+1));
        }
        return profit;
    }

    public static int maxProfitDp(int[]prices,int flag,int index){
