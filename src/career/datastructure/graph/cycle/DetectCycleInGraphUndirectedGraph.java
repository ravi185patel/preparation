...
//        }
        ...
        System.out.println(detectCycleUsingDS(adj,visited));
    }
...
//            System.out.println(i);
    ...
    private static boolean detectCycleUsingDS(int[][] adj,boolean visited[]){
        DisJoinUnion ds = new DisJoinUnion(adj.length+1);
        // need to understand
