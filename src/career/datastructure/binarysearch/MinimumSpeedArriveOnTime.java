 ...
 */
public class MinimumSpeedArriveOnTime {
    public static void main(String[] args) {
        ...
        System.out.println(minSpeedOnTime(new int[]{1,1,100000},2.12)); //833334
    }
    ...
    public static int minSpeedOnTime(int[] dist, double hour) {
        ...
        while(left <= right){
            ...
            double totalHrs = totalHrsToCoverDistGivenSpeed(dist,mid);
            if(totalHrs <= hour){
                ans = mid;
                right = mid -1;
            }else{
    ...
    public static double totalHrsToCoverDistGivenSpeed(int []dist,int speed){
        double total = 0;
